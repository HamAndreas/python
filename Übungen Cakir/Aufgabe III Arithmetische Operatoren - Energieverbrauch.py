...
stromkosten = input("Wie hoch sind die Kosten bei ihrem aktuellen Stomanbieter pro kWh in Euro? ")
...
kosten_jahr = stromverbrauch_jahr * float(stromkosten)

print(f"Der jährliche Stromverbrauch beträgt {round(stromverbrauch_jahr, 2)} kWh und die jährlichen Stromkosten belaufen sich auf {round(kosten_jahr, 2)} Euro.")
